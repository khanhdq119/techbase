<?php
const IP_WHITE_LIST = array('127.0.0.1');
const BASE_URL = 'http://localhost/techbase';
const DB_HOST = "localhost";
const DB_USERNAME = "root";
const DB_PASSWORD = "root";
const DB_DATABASE = "techbase";
const REST_REALM = "TECHBASE API";
const REST_VALID_LOGIN = array('admin'=>'techbase');
const USERNAME_LOGIN = "techbase@company.com";
